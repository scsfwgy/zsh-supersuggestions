...
历史 cycling 使用独立的 `_AI_HIST_*` 状态，由 `zsh-autosuggestions-enhance.sh` 维护，避免与 `Ctrl+L` 的 AI 菜单状态混用。
...
export AI_COMPLETE_HISTORY_PREV_BINDKEY='^U'               # 可选
export AI_COMPLETE_HISTORY_NEXT_BINDKEY='^N'               # 可选
