...
run_test "history enhancement module regression" "$TEST_DIR/test_history_module_load.zsh"
run_test "history widget fallback regression" "$TEST_DIR/test_history_widget_fallback.zsh"
run_test "history candidate cycling regression" "$TEST_DIR/test_history_candidates.zsh"
run_test "history accept reset regression" "$TEST_DIR/test_history_accept_reset.zsh"
